<nav class="sidebar noprint sidebar-offcanvas  bg-light dynamic-active-class-disabled" id="sidebar">
  <ul class="nav bg-light">
    ...
    <li class="nav-item {{ active_class(['proforma']) }}">
      <a class="nav-link" href="{{ url('/proforma/list') }}">
      ...
      <div class="collapse {{ show_class(['settings/*']) }}" id="settings">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item {{ active_class(['lookuptype/list']) }}">
            <a class="nav-link" href="{{ url('/lookuptype/list') }}">lookup type</a>
          </li>
        </ul>
      </div>
    </li> 
