<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('description', $provider->description, ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'placeholder' => 'Description']) }}
            {!! $errors->first('description', '<div class="invalid-feedback">:message</p>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('paymentinfo') }}
            {{ Form::text('paymentinfo', $provider->paymentinfo, ['class' => 'form-control' . ($errors->has('paymentinfo') ? ' is-invalid' : ''), 'placeholder' => 'Paymentinfo']) }}
            {!! $errors->first('paymentinfo', '<div class="invalid-feedback">:message</p>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('email') }}
